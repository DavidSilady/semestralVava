...
public class AppState {
    ...
    private AppState() {
        ...
        Reviews tvshowReviews = (Reviews) XML_ReadWrite.getXML_RW(XML_ReadWrite.TYPREVIEWS).read(System.getProperty("user.dir") + "\\data\\tvshowsreviews.xml");
        
        System.out.println("tvshowReviews = " + tvshowReviews);
        System.out.println("movieReviews = " + movieReviews);
        
        Users usrs = (Users) XML_ReadWrite.getXML_RW(XML_ReadWrite.TYPUSERS).read(System.getProperty("user.dir") + "\\data\\users.xml");
        Movies mvs = (Movies) XML_ReadWrite.getXML_RW(XML_ReadWrite.TYPMOVIES).read(System.getProperty("user.dir") + "\\data\\movies.xml");
        TVShows tvs = (TVShows) XML_ReadWrite.getXML_RW(XML_ReadWrite.TYPTVSHOWS).read(System.getProperty("user.dir") + "\\data\\tvshows.xml");
